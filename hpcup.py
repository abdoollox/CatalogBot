...
# Mavsumda nechta shaxmat natijasi ballanadi. Endi natijani server o'zi
# aniqlaydi (hpchess.py), lekin cheklov baribir SHART: ikki do'st bir-biriga
# ataylab yutqazib cheksiz ball yig'a olardi.
